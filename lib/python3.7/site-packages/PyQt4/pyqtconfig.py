...
_pkg_config = {
    'pyqt_bin_dir':      '/home/fred/PycharmProjects/test/venv/bin',
    'pyqt_config_args':  '--destdir /home/fred/PycharmProjects/gnu-system-monitor/lib/python3.7/site-packages/ --qmake /usr/bin/qmake-qt4',
    'pyqt_mod_dir':      '/home/fred/PycharmProjects/gnu-system-monitor/lib/python3.7/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDBus QtDeclarative QtScript QtScriptTools QtOpenGL QtSql QtSvg QtTest QtXml QtXmlPatterns phonon QtDesigner',
    'pyqt_sip_dir':      '/home/fred/PycharmProjects/test/venv/share/sip/PyQt4',
    'pyqt_sip_flags':    '-n PyQt4.sip -x VendorID -t WS_X11 -x PyQt_NoPrintRangeBug -t Qt_4_8_6 -g',
...
_default_macros = {
    ...
    'CFLAGS_MT_DLL':            '',
    'CFLAGS_MT_DLLDBG':         '',
    'CFLAGS_RELEASE':           '-march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt',
    'CFLAGS_RTTI_OFF':          '',
    'CFLAGS_RTTI_ON':           '',
    'CFLAGS_SHLIB':             '-fPIC',
    'CFLAGS_STL_OFF':           '',
    ...
    'CXXFLAGS_MT_DLL':          '',
    'CXXFLAGS_MT_DLLDBG':       '',
    'CXXFLAGS_RELEASE':         '-march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt',
    'CXXFLAGS_RTTI_OFF':        '',
    'CXXFLAGS_RTTI_ON':         '',
    'CXXFLAGS_SHLIB':           '-fPIC',
    'CXXFLAGS_STL_OFF':         '',
